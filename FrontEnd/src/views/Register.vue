  ...
  <div class="login">
    <el-card class="box-card">
      ...
      <el-form ref="form" style="margin-top: 30px" :model="form" label-width="100px" :label-position="labelPosition" >
        ...
        <el-radio v-model="radio" label="0">我是用户</el-radio>
        <el-radio v-model="radio" label="1">我是管理员</el-radio>
        </el-form-item>
        <el-form-item>
...
export default {
  ...
  methods: {
    async onSubmit() {
      ...
      var status = await axios.post('http://localhost:8080/api/v1/LoginService/Register?PhoneNumber='+userPhone+'&Password='+userPassword+'&UserType='+userType)
